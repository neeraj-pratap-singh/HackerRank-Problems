...
def saveThePrisoner(n, m, s):
    # Calculate the chair number of the prisoner who will get the last piece of candy
    last_chair = (s + m - 1) % n
    
    # If the last chair is 0, it means the last prisoner is the one sitting in chair number n
    if last_chair == 0:
        return n
...
# Test the function
print(saveThePrisoner(4, 6, 2))  # Should output 3
